...
def test_legalPlay():
    ...
    player_1 = SPlayer(color = 'blue', position = Position(0, 1), player = MPlayer(name = 'Michael'))
    ...
    player_2 = SPlayer(color = 'blue', position = Position(11, 0), player = MPlayer(name = 'Michael'))
